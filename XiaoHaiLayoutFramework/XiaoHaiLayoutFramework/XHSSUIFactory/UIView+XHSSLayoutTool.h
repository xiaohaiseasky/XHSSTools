...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// top/left/bottom/right \ width/height \ center/origin/bounds
// => distance().to***View().to***ViewScreenFit()
//
...
//
// up/left/down/right
// => moveBY[to]Num().moveBY[to]NumScreenFit().
//
// *** all those founction nedd to be test one by one
//
// *** group oprate : top().left().bottom().right().###View()[here only can be view , but not anything with top/left/bottom/right]
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
