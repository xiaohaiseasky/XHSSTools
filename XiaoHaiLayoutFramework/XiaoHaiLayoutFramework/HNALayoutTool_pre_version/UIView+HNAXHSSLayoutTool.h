...
#import "UIView+HNAXHSSFrameTool.h"

@interface UIView (HNAXHSSLayoutTool)

#pragma mark - SETTER & GETTER
// 模拟栈结构
@property (nonatomic, strong) NSMutableArray *stack;
// 可存储的四种数据类型
@property (nonatomic, assign) CGFloat laFloatValue;
@property (nonatomic, assign) CGPoint laPointValue;
@property (nonatomic, assign) CGSize laSizeValue;
@property (nonatomic, assign) CGRect laRectValue;
